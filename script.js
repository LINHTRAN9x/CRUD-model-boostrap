...
app.controller('myCtrl',function($scope){
    ...
    $scope.users = [
        {name: 'Kuro', email: 'kuro@yahoo.com', fullname:'Ayasama Kuro'},
        {name: 'Shiro', email: 'shiro@yahoo.com', fullname:'Hatachi Shiro'},
        {name: 'Akai', email: 'Akai@yahoo.com', fullname:'Muramasa Akai'}
    ];
